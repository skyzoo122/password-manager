        ...
        <section>
          <span>
            <button class="profile-btn">
              <img
                class="profile-img"
                src="./../assets/imgs/blank-profile-picture-973460_960_720.webp"
                alt=""
              />
            </button>
      ...
      <div class="container">
        ...
        <div class="passwords">
          <div class="passwords-header">
            ...
            <div class="d1">
              <span class="title-e"><p>Title</p></span>
              <span class="last-edited-e"><p>Last Edited</p></span>
            </div>
          </div>
          <div class="passwords-list">
            <ul>
              <li class="passwords-item">
                <a class="a-card" href="./../show-details/index.html">
